...
badd +29 socket/inc/socket.h
badd +0 socket/src/socket.cpp
argglobal
%argdel
edit socket/inc/socket.h
...
silent! normal! zE
let &fdl = &fdl
let s:l = 29 - ((12 * winheight(0) + 13) / 26)
...
wincmd w
argglobal
if bufexists(fnamemodify("socket/src/socket.cpp", ":p")) | buffer socket/src/socket.cpp | else | edit socket/src/socket.cpp | endif
balt socket/inc/socket.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 55 - ((12 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 55
