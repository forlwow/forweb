...
badd +100 fiber/inc/fiber.h
badd +1 fiber/src/fiber.cpp
badd +60 util/inc/range.h
badd +99 main.cpp
badd +484 /usr/include/features.h
argglobal
%argdel
edit fiber/src/fiber.cpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 123 - ((8 * winheight(0) + 9) / 18)
...
wincmd w
argglobal
if bufexists(fnamemodify("fiber/src/fiber.cpp", ":p")) | buffer fiber/src/fiber.cpp | else | edit fiber/src/fiber.cpp | endif
balt util/inc/range.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 205 - ((7 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 205
...
wincmd w
argglobal
if bufexists(fnamemodify("fiber/inc/fiber.h", ":p")) | buffer fiber/inc/fiber.h | else | edit fiber/inc/fiber.h | endif
...
silent! normal! zE
let &fdl = &fdl
let s:l = 90 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 90
