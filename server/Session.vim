...
badd +89 ./fiber/inc/scheduler.h
badd +135 fiber/src/scheduler.cpp
badd +80 main.cpp
badd +101 ethread/src/ethread.cpp
badd +434 log/src/log.cpp
badd +182 fiber/src/fiber.cpp
badd +40 fiber/inc/fiber.h
badd +0 fiber/inc/scheduler_.h
badd +157 util/inc/threadsafe_deque.h
argglobal
%argdel
$argadd ./fiber/inc/scheduler.h
$argadd fiber/src/scheduler.cpp
edit fiber/inc/scheduler_.h
...
argglobal
if bufexists(fnamemodify("fiber/inc/scheduler_.h", ":p")) | buffer fiber/inc/scheduler_.h | else | edit fiber/inc/scheduler_.h | endif
balt util/inc/threadsafe_deque.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists(fnamemodify("./fiber/inc/scheduler.h", ":p")) | buffer ./fiber/inc/scheduler.h | else | edit ./fiber/inc/scheduler.h | endif
balt util/inc/threadsafe_deque.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 95 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 95
