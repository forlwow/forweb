...
set nomodeline
set ruler
set runtimepath=~/.vim,/etc/vim/plugged/lightline.vim,/etc/vim/plugged/gruvbox,/etc/vim/plugged/coc.nvim,/etc/vim/plugged/rainbow,/etc/vim/plugged/indentLine,/etc/vim/plugged/vim-go,/etc/vim/plugged/vim-godef,/etc/vim/plugged/gocode/vim,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,/etc/vim/plugged/indentLine/after,~/.vim/after
set shiftwidth=4
...
badd +50 fiber/inc/iomanager_.h
badd +1 fiber/src/iomanager_.cpp
badd +69 fiber/inc/iomanager.h
badd +30 fiber/inc/scheduler_.h
badd +262 fiber/src/iomanager.cpp
argglobal
%argdel
edit fiber/inc/iomanager_.h
...
silent! normal! zE
let &fdl = &fdl
let s:l = 64 - ((25 * winheight(0) + 13) / 26)
...
wincmd w
argglobal
if bufexists(fnamemodify("fiber/src/iomanager.cpp", ":p")) | buffer fiber/src/iomanager.cpp | else | edit fiber/src/iomanager.cpp | endif
...
silent! normal! zE
let &fdl = &fdl
let s:l = 204 - ((17 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 204
...
wincmd w
argglobal
if bufexists(fnamemodify("fiber/src/iomanager_.cpp", ":p")) | buffer fiber/src/iomanager_.cpp | else | edit fiber/src/iomanager_.cpp | endif
balt fiber/inc/iomanager_.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 60 - ((8 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 60
...
wincmd w
argglobal
if bufexists(fnamemodify("fiber/inc/iomanager.h", ":p")) | buffer fiber/inc/iomanager.h | else | edit fiber/inc/iomanager.h | endif
balt fiber/src/iomanager.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 45 - ((14 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 45
